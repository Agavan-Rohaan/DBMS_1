...
SELECT YEAR, PRODUCT , SUM(SALES_AMOUNT) AS TOATAL_SALES
FROM SALES_DATA
...
SELECT Product , AVG(SALES_AMOUNT) AS SALE
FROM SALES_DATA
GROUP BY PRODUCT
...
SELECT YEAR , MIN(SALES_AMOUNT) AS MIN_SALE
FROM SALES_DATA
GROUP BY YEAR
...
SELECT TOP 1 REGION , SUM(SALES_AMOUNT) AS TOTAL_SALE
FROM SALES_DATA 
...
SELECT TOP 1 PRODUCT , SUM(SALES_AMOUNT) AS TOTAL_SALE
FROM SALES_DATA 
WHERE YEAR = 2023
GROUP BY PRODUCT
...
SELECT YEAR , REGION , COUNT(PRODUCT) AS TOTAL_ORDER
FROM SALES_DATA
...
SELECT YEAR , SUM(SALES_AMOUNT) AS TOATL_SALE
FROM SALES_DATA
GROUP BY YEAR 
...
SELECT TOP 1 YEAR , SUM(SALES_AMOUNT) AS TOTAL_SALE
FROM SALES_DATA
GROUP BY YEAR
ORDER BY SUM(SALES_AMOUNT)
...
SELECT YEAR , COUNT(PRODUCT) AS TOTAL_ORDER
FROM SALES_DATA
GROUP BY YEAR
